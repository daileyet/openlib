...
import utilities.export.bean.BeanUtils;
...
public abstract class ExportData {
	...
	private static class DefaultExportData extends ExportData {
		...
		private final Map<String, Object> reference = new HashMap<>();
		...
		private void load() throws IntrospectionException {
			BeanInfo beanInfo = Introspector.getBeanInfo(getBeanData().getClass());
