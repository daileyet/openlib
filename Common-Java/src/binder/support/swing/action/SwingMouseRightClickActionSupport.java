 ...
 * under the License.
 *
* @Title: SwingMouseRightClickActionSupport.java 
 ...
 *
 */
public class SwingMouseRightClickActionSupport extends SwingAbstractMouseActionSupport {

	/**
	 * @param actionComponent
	 */
	public SwingMouseRightClickActionSupport(Object actionComponent) {
	 ...
	 */
	public SwingMouseRightClickActionSupport(ActionSupport wrappedActionSupport) {
