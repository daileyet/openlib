...
import sql.dhibernate.support.query.Query;
import sql.dhibernate.support.query.QueryFilter;
import sql.dhibernate.support.query.impl.ContainerFilter;
import sql.dhibernate.support.query.impl.EqualsFilter;
import sql.dhibernate.support.query.impl.NotEqualsFliter;
import sql.dhibernate.support.query.impl.QueryFilterConnects;
import sql.dhibernate.support.query.impl.QueryFilterGroup;
import sql.dhibernate.support.test.TestSession;
