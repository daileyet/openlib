...
public class ViFileSupportType {
	...
	static {
		SUPPORT_LIST_VIDEO = FXCollections
				.unmodifiableObservableList(FXCollections.observableArrayList(
						"*.mkv", "*.flv", "*.ogg", "*.ogv", "*.avi", "*.mov",
						"*.qt", "*.wmv", "*.rm", ".rmvb", "*.mp4", "*.mpg",
						"*.mpeg", "*.3gp", "*.3g2"));
		SUPPORT_LIST_IMAGE = FXCollections
				.unmodifiableObservableList(FXCollections.observableArrayList(
						"*.tiff", "*.png", "*.gif", "*.jpg", "*.bmp", "*.jpeg"));
	}
